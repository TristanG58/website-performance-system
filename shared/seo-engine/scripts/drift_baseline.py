...
from url_safety import validate_url  # noqa: E402  [KAIROS vendored patch: was google_auth]

# [KAIROS vendored patch] DB-Verzeichnis per Env ueberschreibbar (Server-Deploy kontrolliert
# den Baseline-Speicher; Default unveraendert). drift_compare importiert DB_PATH von hier.
DB_DIR = os.environ.get("KAIROS_DRIFT_DB_DIR") or os.path.expanduser("~/.cache/claude-seo/drift")
